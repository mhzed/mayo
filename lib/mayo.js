...
// (c) Zed Zhou,  http://mhzed.com/mayo
// mayo is freely distributable under the MIT license.
//    A generic template engine for javascript, key features include:
//    1. the template language itself is javascript
//    2. supports inheritance via block overriding
//    3. supports embedding external templates
//    4. full support of async call inside template
//    5. works in nodejs and in browser (requires jQeury, for ajax call)
//    6. built-in caching for optimum run time performance,
//
(function () {
var root = this;
function makeMayo(_) {
